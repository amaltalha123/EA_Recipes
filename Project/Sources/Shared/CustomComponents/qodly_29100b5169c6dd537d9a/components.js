import { i as index_cjs, q as qodly_29100b5169c6dd537d9a__mf_v__runtimeInit__mf_v__ } from './assets/qodly_29100b5169c6dd537d9a__mf_v__runtimeInit__mf_v__-CI9ZOr4N.js';
import exposesMap from './assets/virtualExposes-KT3zdYZF.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';

const importMap = {
      
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-B-dTOygQ.js').then(n => n.j),true              ?[]:void 0);
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-DUDAZM33.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-DZY5-c46.js').then(n => n.r),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CiRYyYgr.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-Dbspaoor.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-C-pFqoy6.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-C9SMHHvJ.js'),true              ?[]:void 0);
          return pkg
        }
      ...
      const usedShared = {
          ...
          "react/jsx-runtime": {
            ...
            scope: ["default"],
            loaded: false,
            from: "qodly_29100b5169c6dd537d9a",
            async get () {
...
const initTokens = {};
  ...
  const mfName = "qodly_29100b5169c6dd537d9a";
  async function init(shared = {}, initScope = []) {
    ...
    qodly_29100b5169c6dd537d9a__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
